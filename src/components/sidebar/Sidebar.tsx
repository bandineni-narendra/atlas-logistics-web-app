  ...
  const menuItems = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 13h13l4-4V7l-4 4H3v2zm4 0l-3 4h2l3-4zm0-2l-3-4h2l3 4" />
          </svg>
        ),
      },
      {
        ...
        icon: (
          <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M2 17h20l-3 3H5l-3-3zM5 17v-6l4 2 4-2 4 2v6" />
          </svg>
        ),
      },
    ],
